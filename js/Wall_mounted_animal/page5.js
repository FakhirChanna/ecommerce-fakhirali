...
// -------------------------------------------------------------------
// send json data here
const filePath = "../../json/Wall_mounted_animals.json";
// send image files from folder to here
const get_path = '../../products/Wall_mounted_animals/';
//e

const itemsStartValue = 40;
const itemsLastValue = 50;
